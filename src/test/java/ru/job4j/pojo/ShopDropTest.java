...
class ShopDropTest {
    ...
    @Test
    public void whenArrayLengthIs1AndDeleteElementWithIndex1() {
        Product[] products = new Product[1];
        products[0] = new Product("Bread", 4);
        int index = 1;
        Product[] rsl = ShopDrop.delete(products, index);
        assertThat(rsl[products.length - 1].getName()).isEqualTo("Bread");
    }

    @Test
    public void whenArrayLengthIs1AndDeleteElementWithIndexMinus9() {
        Product[] products = new Product[1];
        products[0] = new Product("Bread", 4);
        int index = -9;
        Product[] rsl = ShopDrop.delete(products, index);
